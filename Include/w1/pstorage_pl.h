...
#define PSTORAGE_DATA_START_ADDR    ((PSTORAGE_FLASH_PAGE_END - 2) * PSTORAGE_FLASH_PAGE_SIZE)  /**< Start address for persistent data, configurable according to system requirements. */
...
#define CMD_QUEUE_SIZE              30                                                          /**< Maximum number of flash access commands that can be maintained by the module for all applications. Configurable. */
